...
- **Phase 1 (MVP)**: Orcha Core + Local CLI + 基础 Cycleround.
- **Phase 2 (Gateway)**: Orcha Shell + Slack Adapter.
- **Phase 3 (Ecosystem)**: 支持 Custom Sub-Agents (Plugins).
- **Phase 4 (Self-Evolve)**: Orcha 能够修改自己的调度代码.
